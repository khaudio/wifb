...
{
    this->readIndex = ((this->readIndex + 1) % this->_ringLength);
}
...
{
    this->writeIndex = ((this->writeIndex + 1) % this->_ringLength);
...
{
    this->processingIndex = ((this->processingIndex + 1) % this->_ringLength);
}
